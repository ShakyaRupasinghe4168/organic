...
import 'package:organic_plate/models/order-model.dart';
import 'package:organic_plate/screens/user-panel/main_screen.dart';
import 'package:organic_plate/services/generate-order-id-service.dart';
...
void placeOrder({
  ...
  required String customerDeviceToken, required String paymentMethod, required String paymentCardNo,
}) async {
    ...
    try {
      ...
      for (var doc in documents) {
        ...
        OrderModel cartModel = OrderModel(
          ...
          customerDeviceToken: customerDeviceToken, paymentMethod: '', cardNumber: '',
        );
